...
const Poster = ({ imageUrl, vote, bgColor }) => {
  ...
  return (
    <div className="  sm:w-fit  h-fit relative cursor-pointer">
      ...
      />
      <div
        className={`flex items-center justify-center ${bgColor} absolute sm:bottom-[-10px] sm:left-[-18px] bottom-[-8px] text-[12px] sm:text-lg font-bold left-[-10px] w-10 h-10  sm:w-14 sm:h-14 rounded-full  `}
      >
